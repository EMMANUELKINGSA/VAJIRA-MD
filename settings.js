...
global.owner = process.env.OWNER_NUMBER  || '18682961912' ;  // ADD YOUR NUMBER WITHOUT +
    
module.exports = {
SESSION_ID: process.env.SESSION_ID || 'VAJIRA-MD=PBFEDBTK#RDsEF-dTH8asmhBISkuZojfQzbXOjklIqYY2wUObUzQ' ,
